...
<html>
    <head>
        <title>Startup Arabia - Connecting dots in the Arabic World</title>
        ...
        <script type="text/javascript">
            function woopraReady(tracker) {
                tracker.setDomain('startuparabia.me');
        ...
        <script type="text/javascript">
            ...
            function initialize() {
                ...
                var myOptions = {
                    zoom: 9,
                    //minZoom: 10,
                    center: new google.maps.LatLng(33.881817,35.498886),
    ...
    <body>
        ...
        <div class="topbar" id="topbar">
            <div class="wrapper">
                <div class="right">
                    <div class="share">
                        <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.startuparabia.me" data-text="Let's put some startups on the map using #startuparabia @conversionpoint @DerekHaddad" data-via="DerekHaddad" data-count="none">Tweet</a>
                        <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
                        <div class="fb-like" data-href="http://www.startuparabia.me" data-send="false" data-layout="button_count" data-width="100" data-show-faces="false" data-font="arial"></div>
                    </div>
                </div>
                <div class="left">
                    <div class="logo">
        ...
        <div class="menu" id="menu">
            ...
            ";
                ...
                ?>
                <li class="blurb">
                    This map was made to connect and promote the Startup scene in the Arab World.
                </li>
        ...
        <div class="modal hide" id="modal_info">
            ...
            <div class="modal-body">
                <p>
                    ...
                    in our beloved Arab World. We've seeded the map but we need
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <p class="help-block">
                                    ...
                                    Test it on google <a href="maps.google.com" target="_BLANKS">maps</a>. first! If it works on Google Maps, it will work here. 
                                </p>
                            </div>
                        </div>
                        <div class="control-group">
